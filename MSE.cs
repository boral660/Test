...
{
    class MSE : IAnalysisMethod
    { 
        // Произвести анализ
   virtual public double Analyse(ref Bitmap first, ref Bitmap second)
        {
        ...
        // Найти разницу между соответствующими пикселями на картинках и возвести в квадрат
